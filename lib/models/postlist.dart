...
class PostListItem {
  ...
  PostListItem.fromJson(Map<String, dynamic> json) {
    ...
    lessonListItem = json['lesson'] != null
        ? new LessonDetails.fromJson(json['lesson'])
        : null;
...
class Media {
  ...
  Media({this.mediaType, this.mediaUrl,this.id,this.mediaThumbnailUrl});
...
class ContentMeta {
  ...
  ContentMeta(
      {this.meta, this.title, this.subtitle1, this.subtitle2});
