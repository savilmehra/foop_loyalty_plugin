            ...
            InkWell(
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    leading: Image.asset('packages/loyalty_foop/assets/appimages/change-password.png',width: 36,height: 36,),
                    title: Text(
            ...
            InkWell(
              ...
              child: Card(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(top: 8, bottom: 8, left: 8),
                    child: ListTile(
                      leading: Image.asset('packages/loyalty_foop/assets/appimages/account-settings.png',width: 36,height: 36,),
                      title: Text(
                        AppLocalizations.of(context!)!
