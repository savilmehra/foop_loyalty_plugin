...
import 'add_cash_approvers.dart';
...
class CashIncentiveApprove extends StatefulWidget {



  CashIncentiveApproveState createState() => CashIncentiveApproveState();
}

class CashIncentiveApproveState extends State<CashIncentiveApprove>
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appAppBar().getCustomAppBar(context,
            appBarTitle: AppLocalizations.of(context!)!.translate('cash_approve'),
            actions: [  InkWell(
              onTap: () {

                Navigator.push(context, MaterialPageRoute(builder: ( context) =>    BlocProvider(
                  create: (_) => CubitMain(),
                  child:     AddCashApprovePage(),
                ),));
